...
write.csv(mut_data,"LUSC_tsg.csv")
...
lusc_tsg <- unique(xchr_tsg[c("GeneSymbol")])

#sums of male mutations
lusc_tsg$male <- c(sum(xchr_tsg$GeneSymbol == "BTK" & xchr_tsg$gender == "male"),
                   ...
                   sum(xchr_tsg$GeneSymbol == "GPC3" & xchr_tsg$gender == "male"),
                   sum(xchr_tsg$GeneSymbol == "AMER1" & xchr_tsg$gender == "male"),
                   sum(xchr_tsg$GeneSymbol == "PHF6" & xchr_tsg$gender == "male"),
                   sum(xchr_tsg$GeneSymbol == "FOXO4" & xchr_tsg$gender == "male"))

#sums of female mutations
lusc_tsg$female <- c(sum(xchr_tsg$GeneSymbol == "BTK" & xchr_tsg$gender == "female"),
                     ...
                     sum(xchr_tsg$GeneSymbol == "GPC3" & xchr_tsg$gender == "female"),
                     sum(xchr_tsg$GeneSymbol == "AMER1" & xchr_tsg$gender == "female"),
                     sum(xchr_tsg$GeneSymbol == "PHF6" & xchr_tsg$gender == "female"),
                     sum(xchr_tsg$GeneSymbol == "FOXO4" & xchr_tsg$gender == "female"))
